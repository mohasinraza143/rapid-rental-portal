...
{  ?>
      ...
      <!--Side-Bar car fillter Dummy types-->
...
<option value="Diesel">Honda</option>
<option value="CNG">Mahindra</option>   
<option value="CNG">Force</option>   
<option value="CNG">BMW</option>   
                </select>
              </div>
              <div class="form-group select">
